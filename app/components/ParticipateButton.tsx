...
export default function ParticipateButton() {
  return (
    ...
    >
      <button className="relative bg-gradient-to-r from-race-red to-race-crimson text-white text-lg md:text-xl font-bold py-5 px-16 rounded-lg shadow-xl overflow-hidden group">
